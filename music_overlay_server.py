...
if __name__ == '__main__':
    ...
    print(f"📊 API URL: http://localhost:5000/api/current-track")
    print("\n🔒 Serveur LOCAL uniquement (non accessible depuis le réseau)")
    print("ℹ️  Open the overlay URL in OBS Browser Source")
    print("="*60 + "\n")
    
    # host='127.0.0.1' = LOCAL ONLY (accessible uniquement depuis ce PC)
